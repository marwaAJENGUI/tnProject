...
import tn.esprit.spring.geo.LookupService;
...
//	{"firstName":"Oussema","lastName":"Saadouli","email":"Oussema@gmail.com","role":"DeliveryMan","username":"oussemasaadouli","password":"oussema"}
...
//		{"username": "oussemasaadouli","password": "oussema"}
	...
	@ResponseBody
	public  Location welcome() throws IOException, GeoIp2Exception { 
		
////		Methode 1 :
	return UserService.givenIP__whenFetchingCity__thenReturnsCityData();
	
//		Methode 2 :
//		LookupService cl = new LookupService("src/test/java/GeoIP/GeoIPCity.dat",LookupService.GEOIP_MEMORY_CACHE);
