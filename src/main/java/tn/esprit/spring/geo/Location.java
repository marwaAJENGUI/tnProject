...
public class Location {
	...
	public String toString() {
		return "Location [countryCode=" + countryCode + ", countryName=" + countryName + ", region=" + region
				+ ", city=" + city + ", postalCode=" + postalCode + ", latitude=" + latitude + ", longitude="
				+ longitude + ", dma_code=" + dma_code + ", area_code=" + area_code + ", metro_code=" + metro_code
				+ "]";
	}
