...
public class Panier implements Serializable{
	...
	public void setBasketWeight(float basketWeight) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + Float.floatToIntBits(basketWeight);
	...
	public boolean equals(Object obj) {
		...
		if (Float.floatToIntBits(basketWeight) != Float.floatToIntBits(other.basketWeight))
			return false;
		if (datePanier == null) {
	...
	public String toString() {
		return "Panier [idPanier=" + idPanier + ", productlines=" + productlines + ", prixTotal=" + prixTotal
				...
				+ remise + ", quantiteTotale=" + quantiteTotale + ", basketWeight=" + basketWeight + "]";
	}
